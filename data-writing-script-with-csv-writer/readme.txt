...
5. Use a for-loop to iterate through lists and write data.
   ...
   2) .writerow() method is the main character here. With it, you can manipulate which data should go under which header.
      In other words, you can set the order of writing data to columns.
